...
namespace Microsoft.Xades.UnitTest
{
    public static class XadesSignManager
    {
        ...
        /// <returns></returns>
        public static string SignWithHashMethodAndEncryptMethod(IDictionary<Uri, Stream> refereces,
            X509Certificate2Collection certificateCollection)
        {
            ...
            xadesSignedXml.HashMethod = (array) =>
            {   
                return hashAlgorithm.ComputeHash(array);
            };
            xadesSignedXml.EncryptMethod = (array) =>
            {
                ...
                return description.CreateFormatter(key).CreateSignature(array);
            };
            ...
            signedSignatureProperties.SigningTime = new DateTime(2000, 1, 1);
